...
Equivalent: `node run_safety_tests.js` — runs **45/45** safety tests including Sprint 4 R6a through R34 guards.
...
| **Recommended next gate** | Operator manual batch; then R35; continue R7b; **do not arm** |
| **Safety suite** | **45/45** |
