...
async function getBoostedTokens() {
  try {
    ...
    console.log("Trending fetch failed:", err.message);
    return [];
  }
}
...
async function scan() {
  console.log("\nScanner Trending: Dex Momentum + GMGN Filters\n");
