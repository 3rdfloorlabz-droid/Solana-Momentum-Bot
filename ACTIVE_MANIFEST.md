...
| **Recommended next gate** | Small manual `--observe-once` batch via `examples/r31_real_quote_candidates.example.json` when operator ready · continue R7b · **do not arm; no trading** |
| **Safety suite** | **43/43** (`node run_safety_tests.js`) |
