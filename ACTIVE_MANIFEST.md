...
| **Recommended next gate** | Continue R7b · R13 research exception only with explicit ack · R14 before any real trade · **R15 Manual Approval Record / Session Runbook** · **do not arm; 1 SOL is liquidity not risk** |
