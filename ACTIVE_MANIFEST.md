...
| **R12 Micro-Live Readiness Checklist** | **COMPLETE — CHECKLIST DEFINED BUT BLOCKED** (2026-06-28) — [docs/R12_MICRO_LIVE_READINESS_CHECKLIST.md](./docs/R12_MICRO_LIVE_READINESS_CHECKLIST.md) · **micro-live NOT approved** |
...
| **Recommended next gate** | Continue R7b if possible · simulated routing fixtures · **do not arm live; 1 SOL is liquidity not risk cap** |
| **Safety suite** | **28/28** (`node run_safety_tests.js`) |
